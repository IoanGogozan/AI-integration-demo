...
export const sessionCookieName = 'norvix_demo_session';
export const defaultAuthSecret = 'norvix-demo-auth-secret';
export const allowedRoles = new Set(['viewer', 'operator', 'reviewer', 'admin']);
...
export function sanitizeUser(user, fallbackRole = 'viewer') {
...
export function getDefaultDemoUsers() {
